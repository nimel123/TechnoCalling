...
const EditCategory: React.FC = () => {
  ...
  const onSubmit1 = handleSubmit1((data: any) => {
    API.postData("update/category/info", data)
      .then((response: any) => {
  ...
  useEffect(() => {
    ...
    API.postData("get/category/info", {
      ...
      .then((response: any) => {
        console.log(response.data);
        if (response.data.status == 1) {
          setValue1("category_code", response.data.category_info.code);
          setValue1("category_name", response.data.category_info.name);
          // let today = new Date(response.data.category_info.expiry);
          // setStartDate(today);
          // setValue1(
          //   "category_expiry",
          ...
          // );
          // let today2 = new Date(
          //   "2024-01-01 " + response.data.category_info.available_to_time
          // );
          ...
          // );
          // let today3 = new Date(
          //   "2024-01-01 " + response.data.category_info.available_from_time
          // );
