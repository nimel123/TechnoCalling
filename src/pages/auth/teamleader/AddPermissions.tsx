...
const AddPermissions: React.FC = () => {
  ...
  useEffect(() => {
    ...
    usersList(techno_calling_admin.uid, 0);
  }, [0]);
  ...
  const showData = () => {
    setadd_answer("0");
    setadd_calling_pitch("0");
    setadd_category("0");
    setadd_question("0");
    setchange_answer_status("0");
    setchange_calling_pitch_status("0");
    setchange_category_status("0");
    setchange_question_status("0");
    setget_active_answer_list("0");
    setget_active_calling_pitch_list("0");
    setget_active_category_list("0");
    setget_active_question_list("0");
    setget_all_answer_list("0");
    setget_all_calling_pitch_list("0");
    setget_all_category_list("0");
    setget_all_question_list("0");
    setinsert_people_extra_columns("0");
    setupdate_answer("0");
    setupdate_calling_pitch("0");
    setupdate_category("0");
    setupdate_people_data("0");
    setupdate_people_extra_columns("0");
    setupdate_question("0");
    setinsert_people_data("0");
    setget_question_info("0");
    setget_answer_info("0");
    setget_category_info("0");
    setget_calling_pitch_info("0");
    setget_all_people_extra_column_list("0");
    setget_active_people_extra_column_list("0");
    setchange_people_extra_column_status("0");
  };
  return (
