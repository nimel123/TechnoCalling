      ...
      <div className="side-bar">
        <div className="container">
          <div className="row">
            ...
            <div className="col-12  vh-100 pb-300 overflow-auto">
              <ul className="sidebar-ul">
                {/* <li
                  onClick={(e: any) => goToPage(e, "/dashboard")}
                ...
                <li
                  onClick={(e: any) => goToPage(e, "/after-calling-comment")}
                  className={
                    location.pathname == "/after-calling-comment"
                      ? "active"
                      : "" ||
                        location.pathname.match(/^\/edit-after-calling-comment/)
                      ? "active"
                      : "" ||
                        location.pathname.match(/^\/add-after-calling-comment/)
                      ? "active"
                      : ""
                  }
                >
                ...
                <li
                  onClick={(e: any) => goToPage(e, "/answer")}
                  className={
                    location.pathname == "/answer"
                      ? "active"
                      : "" || location.pathname.match(/^\/add-answer/)
                      ? "active"
                      : "" || location.pathname.match(/^\/edit-answer/)
                      ? "active"
                      : ""
                  }
                >
